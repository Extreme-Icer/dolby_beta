...
public class ScriptHelper {
    ...
    public static void startScript() {
        String script = String.format("export ENABLE_FLAC=%s&&export MIN_BR=%s&&libnode.so app.js -a 127.0.0.1 -o %s -e %s -p %s",
                ...
                SettingHelper.getInstance().getProxyOriginal(), SettingHelper.getInstance().getProxyEndpoint(), SettingHelper.getInstance().getProxyPort() + ":" + (SettingHelper.getInstance().getProxyPort() + 1));
